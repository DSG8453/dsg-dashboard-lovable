    ...
    <div className="space-y-6">
      ...
      <Card className="border-2 border-border/50 shadow-card">
        ...
        <CardContent className="space-y-4">
          <p className="text-sm text-muted-foreground">
            When you access tools through the dashboard, credentials are handled securely:
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-4 rounded-lg bg-muted/50 border border-border">
              ...
              <p className="text-xs text-muted-foreground">
                All credentials are encrypted and stored securely in Google Secret Manager
              </p>
            </div>
            ...
            <div className="p-4 rounded-lg bg-muted/50 border border-border">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h4 className="font-medium">Zero Visibility</h4>
              </div>
              <p className="text-xs text-muted-foreground">
                Passwords are never visible in plain text - only Super Admins can manage them
              </p>
            </div>
            ...
            <div className="p-4 rounded-lg bg-muted/50 border border-border">
              ...
              <p className="text-xs text-muted-foreground">
                You only see tools that have been specifically assigned to you
              </p>
            </div>
          </div>
        </CardContent>
